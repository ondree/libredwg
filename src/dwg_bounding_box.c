...
static void
calculateLimitsFor (BITCODE_3BD point, BITCODE_BD *minX, BITCODE_BD *maxX,
...
static void
limitsForLayer (Dwg_Data *data, Dwg_Object_LAYER *layer)
{
...
void
forceBoundingBoxForData (Dwg_Data *data, char *source_layer_name)
{
