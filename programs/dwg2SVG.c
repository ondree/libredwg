...
static bool isnan_2pt(dwg_point_2d pt) {
    return isnan (pt.x) || isnan (pt.y);
}

static bool isnan_3BD(BITCODE_3BD pt) {
    return isnan (pt.x) || isnan (pt.y) || isnan (pt.z);
}

static bool isLayerInvisible(Dwg_Object_LAYER *layer) {
...
static bool entity_invisible(Dwg_Object *obj) {
...
static void common_entity(Dwg_Object_Entity *ent) {
    double lweight;
    char *color;
...
static void output_XLINE(Dwg_Object *obj) {
...
static void output_RAY(Dwg_Object *obj) {
...
static void output_POINT(Dwg_Object *obj) {
...
// FIXME
static void output_ELLIPSE(Dwg_Object *obj) {
...
// untested
static void output_SOLID(Dwg_Object *obj) {
...
// untested
static void output_3DFACE(Dwg_Object *obj) {
...
static int output_BLOCK_HEADER(Dwg_Object_Ref *ref) {
    Dwg_Object *obj;
    ...
    if (!obj->tio.object) { // TODO could be an assert also
        fprintf(stderr, "Found null obj->tio.object\n");
        return 0;
    }
    if (!obj->tio.object->tio.BLOCK_HEADER) { // TODO could be an assert also
...
static void output_SVG(Dwg_Data *dwg) {
    ...
    printf("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n"
           ...
           "   viewBox=\"%d %d %f %f\">\n",
           zero, zero, page_width, page_height);
